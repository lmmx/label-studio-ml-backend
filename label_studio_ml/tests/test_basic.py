...
@pytest.mark.second
@pytest.mark.skipif(
    ML_BACKEND != "simple_text_classifier", reason="Test for simple_text_classifier"
)
...
@pytest.mark.second
@pytest.mark.skipif(
    ML_BACKEND != "the_simplest_backend", reason="Test for the_simplest_backend"
)
...
@pytest.mark.second
@pytest.mark.skipif(
    ML_BACKEND != "the_simplest_backend", reason="Test for simple_text_classifier"
)
def test_setup_the_simplest_backend():
    data = {
        "project": "1.1654592272",
